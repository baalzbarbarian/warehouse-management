 ...
 */
public class TatCaHoaDonXHFragment extends Fragment {
    ...
    private HoaDonXHDAO hoaDonDAO;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_tat_ca_hoa_don_xh, container, false);
        initView();
        return view;
    }

    private void initView() {
        recyclerView = view.findViewById(R.id.recyclerView_hdxh_tatca);
        hoaDonDAO = new HoaDonXHDAO(getActivity());
        list = hoaDonDAO.getAllHoaDonXH();
    ...
    public void onResume() {
        super.onResume();
        hoaDonDAO = new HoaDonXHDAO(getActivity());
        adapter.updateData(hoaDonDAO.getAllHoaDonXH());
    }
